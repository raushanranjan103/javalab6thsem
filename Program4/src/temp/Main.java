...
public class Main extends Frame implements ActionListener{
	...
	public void actionPerformed(ActionEvent ev) {
		...
		if(ev.getSource()==bill) {
			...
			int discount = Integer.parseInt(JOptionPane.showInputDialog(this, "Enter the discount percentage"));
			total -= (total*discount/100);
			JOptionPane.showMessageDialog(this , "Discount applied : " + (total*discount/100));
			area.setText(area.getText()+"\nTotal BILL"+total);
			total= 0;
			first = true;
		}
